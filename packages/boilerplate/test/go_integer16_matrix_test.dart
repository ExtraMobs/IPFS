...
void main() {
  test('signed and unsigned operation matrix matches Go', () async {
    ...
    final signed = [
      ...
      '257',
      '32767',
    ].map((v) => Golang.Int16.fromBigInt(BigInt.parse(v))).toList();
    final unsigned = [
      '0',
      '1',
      '2',
      ...
      '32768',
      '65535',
    ].map((v) => Golang.Uint16.fromBigInt(BigInt.parse(v))).toList();
