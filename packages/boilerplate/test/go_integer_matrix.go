...
func main() {
 rows := []any{}
 signed := []int64{-9223372036854775808, -9223372036854775807, -4294967297, -5, -1, 0, 1, 2, 4294967297, 9223372036854775807}
 unsigned := []uint64{0, 1, 2, 4294967297, 9223372036854775807, 9223372036854775808, 18446744073709551615}
