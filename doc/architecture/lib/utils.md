...
module: utils
kind: lib/src audit
generated: 2026-08-24T07:56:45.964446
---
...
Depends on: [core](core.md), [platform](platform.md), [proto](proto.md)
...
- **isValidCIDBytes** (method) — Validate CID bytes according to IPFS spec
  ...
  - referenced by (by name):
    ...
    - `lib/src/core/ipfs_node/utils.dart` (IPFSUtils.isValidCID)
- **indexToCidVersion** (method) — Convert CID version index to enum
