...
| `core/event` | `packages/transpiled_libp2p/lib/src/core/event/{addrs,network,reachability}.dart` | portado sem teste de paridade | Eventos de endereços, conectividade de peer e reachability; demais eventos e event bus ainda pendentes. |
