...
| `core/event` | `packages/transpiled_libp2p/lib/src/core/event/addrs.dart` | portado sem teste de paridade | `AddrAction`, `UpdatedAddress`, `EvtLocalAddressesUpdated` e `EvtAutoRelayAddrsUpdated`; demais eventos e event bus ainda pendentes. |
